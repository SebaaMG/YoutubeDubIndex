...
- 70% pool de contenido: busquedas amplias por familias incluidas en `resources/discovery/content_pool_v4.json` mas busquedas/canales escritos por el usuario.
