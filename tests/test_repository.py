...
class RepositoryTests(unittest.TestCase):
            ...
            json.dumps(
                {
                    "version": "test-v1",
                    "theme_queries": [
                        {"query": "online platform controversy explained", "priority": 45},
    ...
    def test_import_content_pool_can_replace_packaged_system_search_seeds(self) -> None:
        self.repo.create_discovery_seed(
            ...
            value="online platform controversy explained",
            priority=50,
        )
        self.repo.create_discovery_seed(
            seed_kind="user_search",
        ...
        seeds = {seed["value"]: seed for seed in self.repo.list_discovery_seeds()}
        self.assertEqual(seeds["online platform controversy explained"]["enabled"], 0)
